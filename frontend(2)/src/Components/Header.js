...
const Header = () => {
  return (
    <header className="header header--sticky js-header ui-gray">
      <div className="container-h header__content">
        <div className="row row--pad">
          <div className="col col--xl-fill ">
            <a
              href="/"
              className="link-clip link-clip--ready"
              data-plugin="linkAnimation"
              aria-label="Go to Vide Infra homepage"
            >
              <span className="link-clip__content">
                <span>
                  <span>
                    <svg
          ...
          <div className="col col--xl-auto ">
            {/* <div className="menu-toggle ui-gray" data-plugin="themed">
              <a
                className="btn btn--sm btn--square btn--contrast"
                role="button"
                aria-label="Menu"
              ...
              >
                <span className="btn__content">
                  ...
                  >
                    <path
                      d="M12 17H28V18H12V17Z"
                      fill="currentColor"
                      display="var(--is-visible--mobile)"
                    />
                    <path
                      d="M12 22H28V23H12V22Z"
                      fill="currentColor"
                      display="var(--is-visible--mobile)"
                    />
                    <path
                      d="M10 17H30V18H10V17Z"
                      fill="currentColor"
                      display="var(--is-visible--non-mobile)"
                    />
                    <path
                      d="M10 22H30V23H10V22Z"
                      fill="currentColor"
                      display="var(--is-visible--non-mobile)"
                    />
                  </svg>
            ...
            <div className="group group--small">
              <a
                className="btn btn--xs btn--secondary-strict"
                href="contact.html"
                data-plugin="button"
              >
                <span className="btn__content">Войти</span>
              </a>
            </div>
          </div>
        </div>
